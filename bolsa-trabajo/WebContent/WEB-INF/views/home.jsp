    ...
    <main role="main">
      ...
      <div class="container"> 
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <h2>Ingeniero Agrónomo</h2>
            <h6 class="card-title"><strong>Categoría: </strong> <span>Agronomía/Agrícultura</span></h6>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <h6 class="card-title"><strong>Categoría: </strong> <span>Ventas</span></h6>
